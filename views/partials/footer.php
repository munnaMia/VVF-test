    ...
    <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            <div class="text-teal-600">
                <h1 class="text-3xl font-bold">VVF TEST</h1>
            </div>
        ...
        <div
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4 text-sm">
                    <li>
                        <a href="/VVF_Test/about" class="text-gray-700 transition hover:opacity-75"> About </a>
                    </li>
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4 text-sm">
                    <li>
                        <a href="/VVF_Test/Contact" class="text-gray-700 transition hover:opacity-75"> Contact </a>
                    </li>
        ...
        <p class="text-xs text-gray-500">&copy; 2025. Project haider. All rights reserved.</p>
    </div>
</footer>
</body>
